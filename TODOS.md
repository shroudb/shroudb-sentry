...
- [ ] **DEBT-1** — `policy_create` must rollback on audit failure (currently half-committed). Test: `debt_1_policy_create_must_rollback_when_audit_fails` @ `shroudb-sentry-engine/tests/debt_tests_test.rs`.
